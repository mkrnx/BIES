...
const EditEvent = () => {
    ...
    const renderSection = (section, idx) => {
        ...
        return (
            <div key={idx} {...getSectionDragProps(idx)} style={{ marginBottom: '1rem', background: 'white', border: `1px solid ${typeConfig.border}`, borderRadius: '12px', overflow: 'hidden', boxShadow: isBeingDragged ? `0 4px 16px rgba(0,0,0,0.15)` : '0 1px 4px rgba(0,0,0,0.06)', opacity: isBeingDragged ? 0.5 : 1, transition: 'box-shadow 0.2s, opacity 0.2s' }}>
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // For Nostr-native users, publish NIP-52 client-side
